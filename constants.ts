...
export const LEVEL_1: LevelData = {
  ...
  platforms: [
    ...
    // House-like structures / steps (Made smaller)
    // House 1: Smaller width (80->60) and height (100->80)
    ...
    // House 2: Smaller width (80->60) and height (200->140)
    ...
    // Floating platforms
    { id: 'p1', type: EntityType.PLATFORM, x: 600, y: 250, w: 80, h: 20, color: 'bg-green-500' },
    { id: 'p2', type: EntityType.PLATFORM, x: 350, y: 200, w: 80, h: 20, color: 'bg-green-500' },
  ...
  enemies: [
    ...
    // Lowered enemy to sit on new roof height (390)
  ...
  items: [
    ...
    // Lowered carrot to sit near new roof height
    { id: 'c2', type: EntityType.ITEM_CARROT, x: 470, y: 340, w: 20, h: 40 },
    { id: 'c3', type: EntityType.ITEM_CARROT, x: 650, y: 200, w: 20, h: 40 },
  ],
...
export const LEVEL_3: LevelData = {
  ...
  platforms: [
    ...
    // Pyramids / Steps
    { id: 'p1', type: EntityType.PLATFORM, x: 220, y: 450, w: 50, h: 20, color: 'bg-amber-500' },
    { id: 'p2', type: EntityType.PLATFORM, x: 520, y: 450, w: 50, h: 20, color: 'bg-amber-500' },
  ...
  enemies: [
    { id: 'e1', type: EntityType.ENEMY_ROBOT, x: 350, y: 510, w: 40, h: 40, patrolStart: 300, patrolEnd: 500, direction: 1, vx: 3 }, // Fast desert robot
    { id: 'e2', type: EntityType.ENEMY_ROBOT, x: 650, y: 310, w: 40, h: 40, patrolStart: 600, patrolEnd: 700, direction: -1, vx: 2 },
  ],
  items: [
    { id: 'c1', type: EntityType.ITEM_CARROT, x: 150, y: 310, w: 20, h: 40 },
    { id: 'c2', type: EntityType.ITEM_CARROT, x: 400, y: 210, w: 20, h: 40 },
...
export const LEVEL_4: LevelData = {
  ...
  platforms: [
    ...
    { id: 'c4', type: EntityType.PLATFORM, x: 500, y: 300, w: 100, h: 30, color: 'bg-white rounded-full' },
    { id: 'c5', type: EntityType.PLATFORM, x: 650, y: 400, w: 100, h: 30, color: 'bg-white rounded-full' },
    
    { id: 'c6', type: EntityType.PLATFORM, x: 600, y: 150, w: 120, h: 30, color: 'bg-white rounded-full' }, // Goal cloud

    // Maybe a rain cloud (platform you can stand on but it looks dark)
    { id: 'badcloud', type: EntityType.PLATFORM, x: 400, y: 100, w: 80, h: 20, color: 'bg-gray-400 rounded-full' },
  ],
  enemies: [
    { id: 'e1', type: EntityType.ENEMY_ROBOT, x: 170, y: 410, w: 40, h: 40, patrolStart: 150, patrolEnd: 270, direction: 1, vx: 2 },
    { id: 'e2', type: EntityType.ENEMY_ROBOT, x: 520, y: 260, w: 40, h: 40, patrolStart: 500, patrolEnd: 620, direction: -1, vx: 2 },
  ],
  items: [
    { id: 'c1', type: EntityType.ITEM_CARROT, x: 80, y: 260, w: 20, h: 40 },
    { id: 'c2', type: EntityType.ITEM_CARROT, x: 700, y: 360, w: 20, h: 40 },
...
export const LEVEL_5: LevelData = {
  ...
  platforms: [
    ...
    // Conveyor belts (Static for now, just look like it)
  ...
  enemies: [
    // Lots of robots!
    { id: 'e1', type: EntityType.ENEMY_ROBOT, x: 250, y: 410, w: 40, h: 40, patrolStart: 200, patrolEnd: 400, direction: 1, vx: 2.5 },
    { id: 'e2', type: EntityType.ENEMY_ROBOT, x: 550, y: 310, w: 40, h: 40, patrolStart: 500, patrolEnd: 700, direction: -1, vx: 3 },
    { id: 'e3', type: EntityType.ENEMY_ROBOT, x: 250, y: 210, w: 40, h: 40, patrolStart: 200, patrolEnd: 400, direction: 1, vx: 3.5 },
    { id: 'e4', type: EntityType.ENEMY_ROBOT, x: 100, y: 110, w: 40, h: 40, patrolStart: 50, patrolEnd: 200, direction: 1, vx: 4 }, // Boss guard?
  ],
  items: [
  ...
  door: { id: 'exit', type: EntityType.DOOR, x: 50, y: 70, w: 40, h: 80 } // Top left exit
};
